...
## Npm 每月下载量
<ImagePreview src='/img/weekly.png' />

可以看到 `Jest` 的下载量超过了 `Mocha` 很多。

Jest 的下载量较大，一部分原因是因为 create-react-app 脚手架默认内置了 Jest, 而大部分 React 项目都是用它生成的。

> 2025年另外的选择：[Vitest](https://www.npmjs.com/package/vitest) 也是非常好的选择，这两年也是我的首选测试框架，它很好的继承了 Jest 的 API，开箱即用，上手和测试速度都很快，值得用一用！

## Github stars & issues
<ImagePreview src='/img/stats.png' />
...
## 文档对比
### Cypress
<ImagePreview src='/img/cypress-docs.png' />

### Nightwatch
<ImagePreview src='/img/nightwatch.png' />
...
## 25年的更新
目前我认为 `Vitest` 和 `Playwright` 已经都很成熟了，可以作为项目的首选测试框架。