...
## 重构计划
  ...
  - ~~引入 [contentlayer](https://contentlayer.dev/)~~
    - 2026.1.1 由于 contentlayer 不再维护，并且在 `windows` 上编译会丢失部分 `markdown` 文件，所以从 contentlayer 迁移到 [velite](https://velite.org/)
  - [remark](https://www.npmjs.com/package/remark) 等来代替之前的 markdown-it
...
2025.5.21 博客已经装上 `twist-aplayer`，见 [twist-aplayer](https://razzh.cn/posts/twist-aplayer/) 页面
