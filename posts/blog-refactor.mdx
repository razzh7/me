...
## 为什么要重构呢？
  ...
  但是目前博客是将 `markdown` 文件通过 `markdown-it` 来转义成 `html`，并不支持嵌入 `iframe` 的方式来展示视频，我也想要对博客有更加细节的控制，之前在做[Twist-icons](https://twist-icons-docs.vercel.app/)文档中用到了`mdx`，我也对这个方案挺感兴趣，也想研究一下，所以我就有了这个想法。
...
## 四代博客的由来
  ...
  <ImagePreview src='/img/blog1.png' />
...
## 重构计划
  ...
  - 使用 [twist-icons](https://twist-icons-docs.vercel.app/) 替换 react-icons，毕竟这是我自己写的 icon 集合库嘛，得用一下hhh
